...
# Для CI и локальной разработки — fallback; в продакшене (Render) задайте SECRET_KEY в env.
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-dev-and-ci-only-do-not-use-in-production")
